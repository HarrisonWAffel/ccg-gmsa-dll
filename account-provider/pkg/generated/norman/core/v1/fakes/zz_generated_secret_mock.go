...
// Ensure, that SecretListerMock does implement v1.SecretLister.
// If this is not the case, regenerate this file with moq.
var _ v1.SecretLister = &SecretListerMock{}

// SecretListerMock is a mock implementation of v1.SecretLister.
//
//	    func TestSomethingThatUsesSecretLister(t *testing.T) {
//
//	        // make and configure a mocked v1.SecretLister
...
//	        }
//
//	        // use mockedSecretLister in code that requires v1.SecretLister
...
// Ensure, that SecretControllerMock does implement v1.SecretController.
// If this is not the case, regenerate this file with moq.
var _ v1.SecretController = &SecretControllerMock{}

// SecretControllerMock is a mock implementation of v1.SecretController.
//
//	    func TestSomethingThatUsesSecretController(t *testing.T) {
//
//	        // make and configure a mocked v1.SecretController
//	        mockedSecretController := &SecretControllerMock{
//	            AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, handler v1.SecretHandlerFunc)  {
//		               panic("mock out the AddClusterScopedFeatureHandler method")
//	            },
//	            AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler v1.SecretHandlerFunc)  {
//		               panic("mock out the AddClusterScopedHandler method")
//	            },
//	            AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, sync v1.SecretHandlerFunc)  {
//		               panic("mock out the AddFeatureHandler method")
//	            },
//	            AddHandlerFunc: func(ctx context.Context, name string, handler v1.SecretHandlerFunc)  {
...
//	        }
//
//	        // use mockedSecretController in code that requires v1.SecretController
//	        // and then make assertions.
//
//	    }
...
func (mock *SecretControllerMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, handler v1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler v1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, sync v1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddHandler(ctx context.Context, name string, handler v1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) Lister() v1.SecretLister {
...
// Ensure, that SecretInterfaceMock does implement v1.SecretInterface.
// If this is not the case, regenerate this file with moq.
var _ v1.SecretInterface = &SecretInterfaceMock{}

// SecretInterfaceMock is a mock implementation of v1.SecretInterface.
//
//	    func TestSomethingThatUsesSecretInterface(t *testing.T) {
//
//	        // make and configure a mocked v1.SecretInterface
//	        mockedSecretInterface := &SecretInterfaceMock{
//	            AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, sync v1.SecretHandlerFunc)  {
//		               panic("mock out the AddClusterScopedFeatureHandler method")
//	            },
//	            AddClusterScopedFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle v1.SecretLifecycle)  {
//		               panic("mock out the AddClusterScopedFeatureLifecycle method")
//	            },
//	            AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync v1.SecretHandlerFunc)  {
//		               panic("mock out the AddClusterScopedHandler method")
//	            },
//	            AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle v1.SecretLifecycle)  {
//		               panic("mock out the AddClusterScopedLifecycle method")
//	            },
//	            AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, sync v1.SecretHandlerFunc)  {
//		               panic("mock out the AddFeatureHandler method")
//	            },
//	            AddFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, lifecycle v1.SecretLifecycle)  {
//		               panic("mock out the AddFeatureLifecycle method")
//	            },
//	            AddHandlerFunc: func(ctx context.Context, name string, sync v1.SecretHandlerFunc)  {
//		               panic("mock out the AddHandler method")
//	            },
//	            AddLifecycleFunc: func(ctx context.Context, name string, lifecycle v1.SecretLifecycle)  {
...
//	            },
//	            ListFunc: func(opts v1.ListOptions) (*v1.SecretList, error) {
//		               panic("mock out the List method")
//	            },
//	            ListNamespacedFunc: func(namespace string, opts v1.ListOptions) (*v1.SecretList, error) {
...
//	        }
//
//	        // use mockedSecretInterface in code that requires v1.SecretInterface
//	        // and then make assertions.
//
//	    }
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *SecretInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, sync v1.SecretHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddClusterScopedFeatureLifecycle(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle v1.SecretLifecycle) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *SecretInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync v1.SecretHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle v1.SecretLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *SecretInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, sync v1.SecretHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddFeatureLifecycle(ctx context.Context, enabled func() bool, name string, lifecycle v1.SecretLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *SecretInterfaceMock) AddHandler(ctx context.Context, name string, sync v1.SecretHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle v1.SecretLifecycle) {
...
func (mock *SecretInterfaceMock) Controller() v1.SecretController {
...
// List calls ListFunc.
func (mock *SecretInterfaceMock) List(opts v1.ListOptions) (*v1.SecretList, error) {
	if mock.ListFunc == nil {
...
func (mock *SecretInterfaceMock) ListNamespaced(namespace string, opts v1.ListOptions) (*v1.SecretList, error) {
...
// Ensure, that SecretsGetterMock does implement v1.SecretsGetter.
// If this is not the case, regenerate this file with moq.
var _ v1.SecretsGetter = &SecretsGetterMock{}

// SecretsGetterMock is a mock implementation of v1.SecretsGetter.
//
//	    func TestSomethingThatUsesSecretsGetter(t *testing.T) {
//
//	        // make and configure a mocked v1.SecretsGetter
//	        mockedSecretsGetter := &SecretsGetterMock{
//	            SecretsFunc: func(namespace string) v1.SecretInterface {
//		               panic("mock out the Secrets method")
//	            },
//	        }
//
//	        // use mockedSecretsGetter in code that requires v1.SecretsGetter
//	        // and then make assertions.
//
//	    }
...
func (mock *SecretsGetterMock) Secrets(namespace string) v1.SecretInterface {
