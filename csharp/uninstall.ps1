...
# delete the registry reference
Remove-item -path "HKLM:\SYSTEM\CurrentControlSet\Control\CCG\COMClasses\{e4781092-f116-4b79-b55e-28eb6a224e26}"
Remove-item -path "HKLM:\HKEY_CLASSES_ROOT\CLSID\{E4781092-F116-4B79-B55E-28EB6A224E26}"
# also deregister with regsvcs
...
# get rid of the dll directory
Remove-Item -LiteralPath "C:\Program Files\RancherGMSACredentialProvider" -Force -Recurse
